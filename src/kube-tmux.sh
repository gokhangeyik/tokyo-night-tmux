...
KUBE_TMUX_SYMBOL_DEFAULT="$\u2388"
# KUBE_TMUX_SYMBOL_DEFAULT="${KUBE_TMUX_SYMBOL_DEFAULT:-󱃾}"
# KUBE_TMUX_SYMBOL_USE_IMG="${KUBE_TMUX_SYMBOL_USE_IMG:-false}"
KUBE_TMUX_NS_ENABLE="${KUBE_TMUX_NS_ENABLE:-false}"
...
kube_tmux() {
  ...
  local KUBE_TMUX
  # Context
  KUBE_TMUX+="$RESET#[bg=${THEME[bblack]},fg=${THEME[blue]},bold] 󱃾 #[fg=${THEME[foreground]},bg=${THEME[bblack]},bold] ${KUBE_TMUX_CONTEXT} "
